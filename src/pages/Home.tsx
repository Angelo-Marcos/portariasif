...
export function Home() {
    ...
    return (
        <div className="flex-col min-h-screen">
            ...
            <main className="flex pt-[75px] px-48">
                <aside className="flex flex-col w-[276px] max-h-full px-[10px] bg-gray-200 mt-[54px] justify-center overflow-auto">
                    ...
                    <div className="h-full py-2 border-t border-green-700">

                        {
                            ordinancesAside?.ordinances && (
                        ...
                        {
                            !ordinancesAside?.ordinances && (
                                <span className="text-black text-center">Nenhuma portaria encontrada...</span>
                            )
                        }
                    </div>
                </aside>
                ...
                <div className="flex-1 max-h-full mt-[54px] ml-[70px] border-t border-green-300">
                    <span className="flex ml-[13px] mt-[10px] font-medium text-xl text-red-900">
                        Portarias próximas da Data de Encerramento
                    </span>
                    {
                        ordinances?.ordinances && (
                            <div className="w-full mt-4 overflow-x-auto shadow-md border border-green-700 sm:rounded-lg">
                                <table className="w-full font-light text-sm bg-gray-200 dark:text-gray-400">
                                    <thead className="bg-green-700 font-normal border-b dark:bg-green-700 dark:text-white">
                                        <tr>
